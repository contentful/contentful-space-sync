...
function logErrorsWithAppLinks (errors, err, idx, loggedErrors, sourceSpace, destinationSpace) {
  return errors +
    `Error ${idx + 1}:\n` +
    'in ' + parseEntityUrl(sourceSpace, destinationSpace, get(err, 'request.uri')) + '\n' +
